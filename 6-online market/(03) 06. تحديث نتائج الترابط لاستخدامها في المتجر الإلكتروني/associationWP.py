    ...
    for row in rules.itertuples():
      ...
      for product1 in antecedents:
        ...
        for product2 in consequents:
          ...
          #تخيل انت معاك منتجين بثقة 0.6 ويوجد المنتجين بالفعل في الجدول بثقة 0.7 و0.5 
          #يتم حذف المنتجين لل 0.5 بهذا الامر
          #ويمنع اضافة المنتجين ب 0.6 من خلال الأمر بعده
